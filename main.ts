...
const configs: BloomConfig[] = [
    ...
    { label: "Downloading", pattern: [[0, 1, 2], [3, 4, 5], [6, 7, 8]], srgb: [57, 255, 20], p3: [0.25, 0.95, 0.1], stagger: 380, hold: 380, fade: 380, offset: 1000, wrap: false, easing: "linear" },
    ...
    { label: "Uploading", pattern: [[6, 7, 8], [3, 4, 5], [0, 1, 2]], srgb: [0, 255, 127], p3: [0, 0.95, 0.52], stagger: 370, hold: 360, fade: 360, offset: 4000, wrap: false, easing: "linear" },
